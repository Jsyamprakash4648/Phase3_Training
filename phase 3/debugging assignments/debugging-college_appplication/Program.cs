...
namespace Debugging
{
    class Program
    {
        ...
        static void StudentRegistration()
        {
            ...
            while(!tempDate)
            {
                Console.WriteLine("Invali input enter valid date:");
            ...
            //Gender
            GenderEnum gender;
            bool tempGender =Enum.TryParse<GenderEnum>(Console.ReadLine(),true,out gender);
            while(!tempGender)
            {
                System.Console.WriteLine("Invalid Input. Enter a valid Gender");
                tempGender = Enum.TryParse<GenderEnum>(Console.ReadLine(),true,out gender);
            }
            ...
            {
                System.Console.WriteLine("Invalid Input. Enter a Valid Mark.");
                bool Maths = int.TryParse(Console.ReadLine(), out maths);
            }
